! function(e) {
    ...
    var o = n(8),
        ...
        _ = function(e) {
            ...
            }, t.prototype.attachmentsActions = function(e, t, n,p='') {
				//console.log(p);
    ...
    var s, c, l, u, d, p, h, f, m, b, g, y, v, S, O, w, T, C, A, E, F, j, N, R, I, L, _, P, D, M, k, x, U, H, B, G, K, V, z, q, W, Y, $, J, X, Z, Q, ee, te, ne, oe, ie = n(8),
        ...
        St = (R = Object(ot.view)({
            ...
            return le()(t, e), t.prototype.closeMessageCommand = function() {
				...
				//console.log('saveToOwnCloud');
				var e = this,
				t = this.getAttachmentsHashes();
				
				if(0 < t.length)
				{
					parent.OC.dialogs.RL_filepickertosave(
						parent.t('mail', 'Choose a Folder'),
						function(path) {
							if (typeof callback === 'function') {
								callback();
							}
							0 < t.length ? ze.a.attachmentsActions("OwnCloud", t, e.saveToOwnCloudLoading,path).then(function(t) {
								//console.log(t);
								t && t.Result ? e.saveToOwnCloudSuccess(!0) : e.saveToOwnCloudError(!0)
							}).catch(function() {
								e.saveToOwnCloudError(!0)
							}) : e.highlightUnselectedAttachments(!0)
						},
						false,
						'httpd/unix-directory',
						false
